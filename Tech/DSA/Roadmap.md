...
2. Each problem links directly to Leetcode (or GFG where mentioned)
3. **Problems marked `✅ Neetcode` are part of Neetcode 150** — skip if already done, but revise if shaky
4. **Problems marked `🔥 Must-do for MAANG`** — non-negotiable, do these before interviews
5. Use the rating column to mark difficulty after solving: ⭐ (easy for me) / ⭐⭐ (struggled) / ⭐⭐⭐ (had to look up)
6. Re-attempt ⭐⭐⭐ problems after 2 weeks
...
> Build the foundation. Most MAANG warmup questions come from here.
...
- [ ] [Burst Balloons](https://leetcode.com/problems/burst-balloons/) — Hard ✅ Neetcode 🔥 **(Classic interval DP)**
- [ ] [Matrix Chain Multiplication](https://www.geeksforgeeks.org/matrix-chain-multiplication-dp-8/) — Medium (GFG) 🔥
...
- [ ] [Travelling Salesman Problem](https://www.geeksforgeeks.org/travelling-salesman-problem-using-dynamic-programming/) — Hard (GFG) 🔥
...
- [ ] [Maximum Subarray](https://leetcode.com/problems/maximum-subarray/) — Medium (revisit greedily)
- [ ] [Jump Game](https://leetcode.com/problems/jump-game/) — Medium ✅ Neetcode 🔥
- [ ] [Jump Game II](https://leetcode.com/problems/jump-game-ii/) — Medium ✅ Neetcode 🔥
- [ ] [Gas Station](https://leetcode.com/problems/gas-station/) — Medium ✅ Neetcode 🔥
- [ ] [Hand of Straights](https://leetcode.com/problems/hand-of-straights/) — Medium ✅ Neetcode
...
- [ ] [Implement Trie (Prefix Tree)](https://leetcode.com/problems/implement-trie-prefix-tree/) — Medium ✅ Neetcode 🔥
- [ ] [Design Add and Search Words Data Structure](https://leetcode.com/problems/design-add-and-search-words-data-structure/) — Medium ✅ Neetcode 🔥
- [ ] [Word Search II](https://leetcode.com/problems/word-search-ii/) — Hard ✅ Neetcode 🔥
...
# 🏁 Contest Tracker (Every Weekend)

> Mandatory. Non-negotiable. Track your rating progress.
...
1. **No easy problems.** You've already solved 120. Stop doing more unless they're in this list.
2. **Hard problem first every day.** Discomfort tolerance is the muscle you're training.
3. **45-minute timer on every problem.** If unsolved after 45 minutes, look at the editorial. Understand. Re-solve from scratch the next day.
4. **Write the solution out by hand once a week.** Forces cleaner thinking.
5. **Re-attempt ⭐⭐⭐ (struggled) problems after 14 days.** Pattern recognition only sticks with spaced repetition.
6. **Sunday contest is mandatory.** Even if you've had a bad week. Especially if you've had a bad week.
7. **Skip Codeforces unless you genuinely enjoy it.** Time is finite.
8. **Don't grind on weekends past 6 hours.** Burnout breaks the entire plan.
